      ...
      !isStats && (
        <div className="right-navbar">
          ...
          <div className="search-box">
            <input type="text" className="search-input" name="filter" />
            <div className="filter-button"><img src="https://img.icons8.com/small/100/000000/sorting-options.png" className="filter-button-icon" alt="filter" /></div>
          </div>
        </div>
      )
    }
